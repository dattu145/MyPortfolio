          ...
          <div className="relative w-full max-w-md mx-auto aspect-square rounded-2xl lg:rounded-3xl overflow-hidden border border-zinc-800 dark:border-zinc-700">
            ...
            <div className="absolute top-3 right-3 sm:top-4 sm:right-4 lg:top-6 lg:right-6">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="px-3 py-2 sm:px-4 sm:py-2.5 lg:px-6 lg:py-3 bg-white dark:bg-gray-100 text-black dark:text-gray-900 font-medium rounded-lg hover:bg-gray-100 dark:hover:bg-white transition-colors inline-flex items-center gap-1 sm:gap-2 text-xs sm:text-sm"
              >
